...
export const ContactUs = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center w-full" >
      <h1 className=' flex flex-col justify-center items-center mt-7 text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-magenta via-citrus to-aqua w-80'>Contact Us Form</h1>
