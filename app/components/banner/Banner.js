  ...
  return (
    <div className="bg-[url('/assets/ragingbull_mirror.jpg')] bg-cover bg-center w-screen h-96 grid grid-cols-11 md:grid-cols-12 grid-rows-6">
      ...
      <div
        ...
        <h1 className="font-bold text-3xl flex justify-start py-2 content-end text-black">Welcome to <Image src="./assets/BRUMAI_BLACK.svg" width="150" alt="brumAI logo" height="100" className="ml-2"/></h1>
