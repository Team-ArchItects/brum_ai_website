...
export default function Footer() {
  return (
    <section className="flex flex-col w-screen justify-between">
      <source srcSet="/assets/footer_black.png" media="(prefers-color-cheme: dark)" />
      {/* <Image src="/assets/footer_white.png" alt="Footer graffiti" width="500" height={100} /> */}
      <div className="bg-[url('/assets/footer_white.png')] w-screen h-48"></div>
