export default function GetInvolved({ data }) {
  ...
  return (
    <section className={ `bg-[url("/assets/getinvolvedgraphic_black2.png")] dark:bg-[url("/assets/getinvolvedgraphic_white.png")] dark:text-black text-white bg-center bg-cover bg-no-repeat w-full min-w-[340px] min-h-[400px] max-w-[1900px] flex justify-center items-center pt-12 pb-20 px-0 lg:px-16 xl:px-36 2xl:px-64` }>
