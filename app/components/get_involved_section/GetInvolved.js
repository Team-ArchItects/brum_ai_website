export default function GetInvolved () {
    return (
        <section className="bg-[url('/assets/getinvolvedgraphic_white.png')] bg-center bg-cover bg-no-repeat w-full min-w-[400px] min-h-[400px] max-w-[1400px] flex justify-center items-center pt-8 pb-16 lg:py-4 xl:py-2 2xl:py-2 px-8 lg:px-16 xl:px-36 2xl:px-64">
            <div className="w-9/12 flex flex-col items-center p-1 min-h-[333px]">
