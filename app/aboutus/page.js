  ...
  return (
    <section>
      <div className="flex flex-col items-center justify-between ">
        ...
        <div className="items-center grid grid-cols-1 md:grid-cols-2 gap-x-4 w-full lg:w-9/12 space-y-4 space-x-4">
      ...
      <div className="flex flex-col items-center justify-between ">
        ...
        <div className="items-center grid grid-cols-1 md:grid-cols-3 gap-x-4 w-full lg:w-9/12 space-y-4 space-x-4">
